...
if(isset($_GET['id']) && isset($_GET['code']))
{
    ...
    $query = "SELECT * FROM tbl_owner WHERE owner_id='$id' AND code='$code' LIMIT 1";
    $result = mysqli_query($con,$query);
    if($result){
        $row = mysqli_fetch_array($result);
        $owner_id = $row['owner_id'];
            if(isset($_POST['reset_owner_password'])){
                ...
                if(empty($new_password) || empty($confirm_password)){
                    ...
                    $owner_password  = md5($confirm_password);
                    $update_password_query = "UPDATE tbl_owner SET password='$owner_password' WHERE owner_id='$owner_id'";
                ...
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" action="" method="POST" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <button id="submit" name="reset_owner_password" class="btn btn-primary">Reset Password</button>                       
                            </div>
                        </div>
                    </form>
                </div>              
