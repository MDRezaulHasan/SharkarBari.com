...
if(isset($_POST['submit'])){
    ...
    if(empty($email)){
        ...
        $query = "SELECT * FROM tbl_tenant WHERE tenant_email='$email' LIMIT 1";
            ...
            if($count > 0){
                if($row['status'] == "Y"){
                    if($row['ban'] == "0"){
                        ...
                        $id=base64_encode($row['tenant_id']);
                        $code = md5(uniqid(rand()));

                        $reset_query = "UPDATE tbl_tenant SET code='$code' WHERE tenant_email='$email'";
                        ...
                        $message= "Hello , $email
                                    ...
                                    <br /><br />
                                    <a href='http://localhost/sharkarbari.com/reset-password-tenant.php?id=$id&&code=$code'>click here to reset your password</a>
                                    <br /><br />
                                    thank you  ";
