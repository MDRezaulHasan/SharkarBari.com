...
global $con;
if(isset($_GET['unban_rent_ads_id'])){
    $unban_rent_ads_id = mysqli_real_escape_string($con,$_GET['unban_rent_ads_id']);
    
    $unban_rent_ads_query = "UPDATE tbl_flat_rent_ads SET ban='N' WHERE id='$unban_rent_ads_id'";
    $unban_rent_ads = mysqli_query($con, $unban_rent_ads_query);
    if($unban_rent_ads){
        echo "<script>alert('This Ads is Unbanned!')</script>";
        echo "<script>window.open('ban-rent-ads.php','_self')</script>";
    }else{
...
?>
    ...
    <div class="main-bar">
        <h3>
            <i class="fa fa-ban"></i>&nbsp; Ban Rent Ads List
        </h3>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12"   style="margin-top:50px;margin-bottom: 50px;">
                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php 
                                $query  = "SELECT tbl_flat_rent_ads.*, tbl_owner.* FROM tbl_flat_rent_ads INNER JOIN tbl_owner ON tbl_flat_rent_ads.owner_id = tbl_owner.owner_id WHERE tbl_flat_rent_ads.approved='Y' AND tbl_flat_rent_ads.ban='Y' ORDER BY tbl_flat_rent_ads.id DESC";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?unban_rent_ads_id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure to unban this Ads?');" data-placement="top" data-toggle="tooltip" title="Unban">
