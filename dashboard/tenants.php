...
global $con;
if(isset($_GET['ban_tenant_id'])){
    $ban_tenant_id = mysqli_real_escape_string($con,$_GET['ban_tenant_id']);
    $ban_query = "UPDATE tbl_tenant SET ban='1' WHERE tenant_id='$ban_tenant_id'";
    $ban_tenant = mysqli_query($con, $ban_query);
    if($ban_tenant){
        echo "<script>alert('This Tenant is Banned!')</script>";
        echo "<script>window.open('tenants.php','_self')</script>";
    }else{
        echo "<script>alert('This Tenant is not Banned!')</script>";
        echo "<script>window.open('tenants.php','_self')</script>";
    }
                ...
                <div class="row">
                    ...
                    <div class="col-md-12"   style="margin-top:50px;margin-bottom: 50px;">
                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php 
                                $query  = "SELECT tbl_tenant.*,tbl_owner.* FROM tbl_tenant INNER JOIN tbl_owner ON tbl_tenant.owner_id=tbl_owner.owner_id WHERE tbl_tenant.ban='0' ORDER BY tenant_id DESC";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?ban_tenant_id=<?php echo $row['tenant_id'];?>" onclick="return confirm('Are you sure to ban this tenant?');" data-placement="top" data-toggle="tooltip" title="Ban">
