...
?>
    ...
    <div class="main-bar">
        <h3>
            <i class="fa fa-eye"></i>&nbsp; View Tenant Notice
        </h3>
    </div>
            ...
            <div class="inner bg-light lter">                                              
                <div class="row">
                    <div class="col-md-12 text-align-left"   style="margin-top:50px;margin-bottom: 50px;">
                        <?php
                        if(isset($_POST['ok'])){
                            echo "<script>window.location = 'tenant-notice-to-owner.php';</script>";
                        }
                        ?>
                        <?php
                        if(isset($_GET['view_tenant_notice_id'])){
                            global $con;
                            $view_tenant_notice_id = mysqli_real_escape_string($con,$_GET['view_tenant_notice_id']);
                            $select_query = "SELECT * FROM tbl_tenant_notice WHERE tenant_notice_id='$view_tenant_notice_id'";
