...
?>
    ...
    <div class="main-bar">
        <h3>
            <i class="fa fa-eye"></i>&nbsp; View Customer To Owner Message
        </h3>
    </div>
            ...
            <div class="inner bg-light lter">                                              
                <div class="row">
                    <div class="col-md-12 text-align-left"   style="margin-top:50px;margin-bottom: 50px;">
                         <?php
                        if(isset($_POST['ok'])){
                            echo "<script>window.location = 'customer-message.php';</script>";
                        }
                        ?>
                        <?php
                        if(isset($_GET['customer_msg_view_id'])){
                            $msg_id = mysqli_real_escape_string($con,$_GET['customer_msg_view_id']);
                        ...
                        <form class="form-horizontal" action="" method="POST">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="owner_email">Receiver (Owner Email)</label>  
                                <div class="col-md-7">
                                    <input id="owner_email" name="owner_email" type="email" value="<?php echo $row['owner_email'];?>" class="form-control input-md" readonly>
                                </div>
                            </div>                           

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="customer_email">Sender (Customer Email)</label>  
                                <div class="col-md-7">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="customer_phone_num">Customer Phone Number</label>  
                                <div class="col-md-7">
