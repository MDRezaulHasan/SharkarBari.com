...
if(!isset($_GET['flat_sell_id']) || $_GET['flat_sell_id'] == NULL){
    ...
    $query = "SELECT * FROM  tbl_flat_sell_ads WHERE id='$flat_sell_id' AND owner_id='$owner_id'";
    ...
    $delquery = "DELETE FROM tbl_flat_sell_ads WHERE id='$flat_sell_id' AND owner_id='$owner_id'";
